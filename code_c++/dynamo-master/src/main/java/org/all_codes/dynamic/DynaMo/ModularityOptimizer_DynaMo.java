...
public class ModularityOptimizer_DynaMo{
	public static double resolution_default=0.5;
	public static int nRandomStarts_default=2;
	public static int nIterations_default=100;
	public static long randomSeed_default=10;
	...
	public static void runDynamicModularity_syn(String dataSet, int nbatch) throws IOException, ClassNotFoundException{
		String DyNet="/home/lipu/CoDeSEG_new/code_c++/dynamo-master/src/main/java/org/dzhuang/dynamic/preprocessing/data/"+dataSet+"/ntwk2/";
		String intNet="/home/lipu/CoDeSEG_new/code_c++/dynamo-master/src/main/java/org/dzhuang/dynamic/preprocessing/data/"+dataSet+"/inct/";
		/**********************************************************************************/
        ...
        int n_cnt=0;
        BufferedReader br = new BufferedReader(new FileReader("/home/lipu/CoDeSEG_new/code_c++/dynamo-master/src/main/java/org/dzhuang/dynamic/preprocessing/data/"+dataSet+"/1_com_ground_truth"));
		String line2="";
		...
		int n_cnt2=0;
		br = new BufferedReader(new FileReader("/home/lipu/CoDeSEG_new/code_c++/dynamo-master/src/main/java/org/dzhuang/dynamic/preprocessing/data/"+dataSet+"/1_com_ground_truth"));
		while ((line2=br.readLine()) != null) {
        ...
        writeOutputFile("/home/lipu/CoDeSEG_new/code_c++/dynamo-master/src/main/java/org/dzhuang/dynamic/preprocessing/data/"+dataSet+"/result/1.txt", clustering);
        ...
        for(int ibatch=2;ibatch<=nbatch;ibatch++){
            ...
            /**********************************************************************************/
            writeOutputFile("/home/lipu/CoDeSEG_new/code_c++/dynamo-master/src/main/java/org/dzhuang/dynamic/preprocessing/data/"+dataSet+"/result/"+ibatch+".txt", clustering);
...
//            pw.println(ibatch+"\t"+maxModularity2+"\t"+(t2-t1+t)+"\t"+(t2-t1)+"\t"+t);
	...
	public static void runDynamicModularity(String dataSet, int nbatch) throws IOException, ClassNotFoundException{
        ...
        for(int ibatch=2;ibatch<=nbatch;ibatch++){
            ...
            System.out.println(dataSet+"\t"+"DynaMo"+"\t"+ibatch+"\t"+maxModularity2+"\t"+(t2-t1+t));
            // pw.println(ibatch+"\t"+maxModularity2+"\t"+(t2-t1+t)+"\t"+(t2-t1)+"\t"+t);
            pw.println(maxModularity2+"\t"+(t2-t1+t));
            // next old network
            oldNetwork=new Network(newNetwork.nNodes, newNetwork.firstNeighborIndex, newNetwork.neighbor, newNetwork.edgeWeight);
