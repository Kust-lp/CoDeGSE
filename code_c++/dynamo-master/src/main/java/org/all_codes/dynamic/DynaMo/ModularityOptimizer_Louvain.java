...
public class ModularityOptimizer_Louvain{
	...
	public static void runLouvain(String dataSet, int nbatch) throws IOException, ClassNotFoundException{
		...
		for(int ibatch=1;ibatch<=nbatch;ibatch++){
	        ...
	        /***************************************************************************/
//	        writeOutputFile("/home/lipu/CoDeSEG_new/code_c++/dynamo-master/src/main/java/org/dzhuang/dynamic/preprocessing/data/"+dataSet+"/runLouvain_"+dataSet+"_com_"+(ibatch+1), clustering);
	        writeOutputFile("/home/lipu/CoDeSEG_new/code_c++/dynamo-master/src/main/java/org/dzhuang/dynamic/preprocessing/data/"+dataSet+"/runLouvain_"+dataSet+"_com_"+ibatch, clustering);
