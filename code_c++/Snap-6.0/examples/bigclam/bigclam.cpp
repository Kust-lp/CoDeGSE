...
int main(int argc, char* argv[]) {
  ...
  TStr DataName = Env.GetIfArgPrefixStr("-d:", "", "dataset name");
  ...
  TAGMUtil::DumpCmtyVV(OutFPrx + DataName + "cmtyvv.txt", EstCmtyVV, NIDNameH);
  TAGMUtil::SaveGephi(OutFPrx + DataName + "graph.gexf", G, EstCmtyVV, 1.5, 1.5, NIDNameH);
